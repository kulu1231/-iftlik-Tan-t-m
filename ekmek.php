...
<li><a href="ekmek.php" style="background-color:red;color:white;">Ekmek</a></li>
</ul><br /><br />
...
$sorgu = "select urun_id,urun_resim,urun_adi,urun_adi2,fiyat from urunler where kategori_id=5";
