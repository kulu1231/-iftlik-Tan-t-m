...
<li><a href="yumurta.php">Yumurta &amp; Sucuk</a></li>
...
$sorgu = "select urun_id,urun_resim,urun_adi,urun_adi2,urun_detay,fiyat from urunler where urun_id=$id";
$stat = $baglan->prepare($sorgu);
$stat->execute();
$stat->bind_result($id,$resim2,$ad,$ad2,$detay,$fiyat);
while($stat->fetch())
{
	echo "<img src=".$resim2." width=220 height=200  />"."<br />";
	echo $detay;
}
