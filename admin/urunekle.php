...
$fiyat = $_POST["fiyat"];
$kategori = $_POST["katno"];
if($resim!=""&&$urunadi!=""&&$urunadi2!=""&&$fiyat!=""&&$icerik!=""&&$kategori!="")
{

$sql = "insert into urunler(urun_resim,urun_adi,urun_adi2,fiyat,kategori_id) values('$resim','$urunadi','$urunadi2','$fiyat','$kategori')";
...
?>
  ...
  <form method="post" action="">
    <div class="form-group">
      <label for="email">Resim Yolu</label>
      <input type="text" class="form-control" id="email" name="resim">
    </div>
    <div class="form-group">
      <label for="pwd">Ürün Adı</label>
      <input type="text" class="form-control" id="pwd" name="urunadi">
    </div>
     <div class="form-group">
      <label for="pwd">Diğer Ürün Adı</label>
      <input type="text" class="form-control" id="pwd" name="urunadi2">
    </div>
    <div class="form-group">
      <label for="pwd">Fiyat</label>
      <input type="text" class="form-control" id="pwd" name="fiyat">
    </div>
   
    <div class="form-group">
      <label for="pwd">Kategori No</label>
      <input type="text" class="form-control" id="pwd" name="katno">
    </div>
