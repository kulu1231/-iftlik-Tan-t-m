...
<div id="slider"><div class="w3-content w3-display-container" style="max-width:100%">
  <img class="mySlides" src="images/sokaBanner-124-.jpg" style="width:100%">
  <img class="mySlides" src="images/Hasanbeycom_banner-33-.jpg" style="width:100%">
   <img class="mySlides" src="images/gunluk_koy_yumurta-27-.jpg" style="width:100%">
 

  <button class="w3-button w3-black w3-display-left" onclick="plusDivs(-1)">&#10094;</button>
  <button class="w3-button w3-black w3-display-right" onclick="plusDivs(1)">&#10095;</button>
</div></div>
<div id="banner2"><img src="images/domatesbiber0-8-.jpg" width="537" height="287" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/yorum.PNG" width="306" height="285" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/yumurta_sd-7-.jpg" width="430" height="292" /></div>
<center><h1>YENİ LEZZETLERİMİZ</h1></center>
<div id="urunler">
<?php
include("baglanti.php");
$sorgu = "select urun_id,urun_resim,urun_adi,urun_adi2,fiyat from urunler";
