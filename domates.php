...
<li><a href="domates.php" style="background-color:red;color:white;">Domates &amp; Biber</a></li>
...
$sorgu = "select urun_id,urun_resim,urun_adi,urun_adi2,fiyat from urunler where kategori_id=1";
